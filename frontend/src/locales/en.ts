export default {
  ...
  settings: {
    ...
    wsl: {
      title: 'Auto-start WSL',
      desc: 'Start WSL together with ProcHub on boot (Windows only)',
      requiresAutoStart: 'Enable "Launch at Startup" first',
      ...
      start: 'Start',
      restart: 'Restart',
      startFailed: 'Failed to start WSL',
      restartFailed: 'Failed to restart WSL',
    },
    version: {
